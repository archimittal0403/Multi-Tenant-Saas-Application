...
<?php if($institute_type == 'college'){ ?>
   ...
   <a href="pdf.php?type=semester_report&course=<?= $course ?>&branch=<?= $branch ?>&session=<?= $session ?>&semester=<?= $semester ?>&subject_id=<?= $subject_id ?>"
...
<?php } else { ?>
   ...
   <a href="pdf.php?type=semester_report&class=<?= $class ?>&section=<?= $section ?>&session=<?= $session ?>&subject_id=<?= $subject_id ?>"
   class="btn btn-danger">
   📄 Generate PDF
</a>
