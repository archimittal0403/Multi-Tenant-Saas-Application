...
$update_metadata=mysqli_query($con,"UPDATE metadata SET meta_value='$update_department' WHERE meta_key='course' AND item_id='$update_id'");
if($update_posts || $update_metadata){
          echo "<div class='alert alert-success'>course already addeded Successfully</div>";
 echo "<script>window.location='branch.php?success=1';</script>";
}
}
...
LEFT JOIN metadata d 
    ON d.item_id = p.id AND d.meta_key='course'
            ...
            <form method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <?php
                          $course_id=$get_data['course'];
                $course_name=mysqli_query($con,"SELECT title FROM posts WHERE id='$course_id'");
                ...
                <p><?php echo $course ?></p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="department" class="form-control"
                               value="<?= $get_data['department']; ?>" required>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <label class="form-label fw-bold">Description</label>
                          <input type="text" name="description" class="form-control"
                               value="<?= $get_data['description']; ?>" required>
                    </div>
