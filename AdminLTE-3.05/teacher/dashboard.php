...
<div class="content-header">
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="teacher_detail.php" class="btn btn-primary btn-sm">
                            View Profile
                        </a>
  ...
  <?php $student_photo=get_usermeta($user_id,'th_image');?>
                  <img class="profile-user-img img-fluid img-circle" src="../admin/uploads/teacher_photo/<?php echo $student_photo ?>" alt="User profile picture">
...
$teacher_id=$row_details['roll_no']
...
?>
                            ...
                            <div class="profile-info mt-3">
                                ...
                                $college=mysqli_query($con,"SELECT name FROM institutes WHERE id='$institute_id'");
                                $get_college=mysqli_fetch_assoc($college);
                                $college_name=$get_college['name'];
                                echo $college_name;
                                ?>
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="teacher_notice.php" class="btn btn-outline-primary btn-sm">
                            View More
                        </a>
                    ...
                    SELECT * FROM notices
                    WHERE institute_id='$institute_id' AND audience='teachers'
                    ORDER BY id DESC
                    LIMIT 1
                    ");
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="dashboard-card">
                    ...
                    WHERE institute_id='$institute_id' AND teacher_id='$user_id'
                    ORDER BY id DESC
                    LIMIT 4
                    ");
