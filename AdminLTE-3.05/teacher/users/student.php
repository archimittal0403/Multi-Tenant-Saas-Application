               ...
               <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <select name="religion" id="religion" class="form-control">
                    ...
                    $religious=['Hindu','muslium','cristian','buddism','jainism','other'];
                    foreach($religious as $value) {
                      $selected= ($religious==$value)? 'selected' : '';
                      echo '<option value="' .$value. '"' .$selected . '>' .$value . '</option>';
                    } ?>
                ...
                <div class="form-group">
                  ...
                  <select name="class" id="class_id" class="form-control" required>
                    ...
                    foreach($classes as $class){
                      $selected=($classes==$class)? 'selected' : '';
...
?>
   ...
   <?php
                ...
                <tr>
                       ...
                       <td>
                        <input type="file" name="documentation[previous_marksheet]">
                        <?php 
                        if(!empty($marksheet)) {
                ...
                <th>Previous TC</th>
                <td>
                  <input type="file" name="documentation[previous_tc]">
                  <?php
                  if(!empty($tc)) {
...
},
{
  ...
  processing: true,
      ...
      <script>
  jQuery('#student.php').on('submit', function(e) {
    // console.log();
    e.preventDefault();
    if (true) {
      ...
      jQuery.ajax({
        type: "post",
        url: "http://localhost/student%20management/AdminLTE-3.05/admin/student.php",
        data: formdata,
        cache: false,
        contentType: false,
        processData: false,
...
<div class="modal fade" id="user-import-modal" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="http://localhost/student%20management/AdminLTE-3.05/admin/student.php" method="post" enctype="multipart/form-data">
