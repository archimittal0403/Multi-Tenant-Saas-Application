...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/student_result.php" class="nav-link">
    ...
    <a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/std_att.php" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/exam_attendance.php" class="nav-link">
...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/study.php" class="nav-link">
...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/student_feedback.php" class="nav-link">
            ...
            <!-- <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/All_feedback_form.php" class="nav-link">

                <i class="far fa-circle nav-icon"></i>

                <p>All Feedback Forms</p>
...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/live-chat.php" class="nav-link">
...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/user_notice.php" class="nav-link">
...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/admit_card.php" class="nav-link">
...
<a href="javascript:void(0);" class="nav-link menu-toggle">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              ...
              <a href="<?=$site_url?>student/student_assignment.php" class="nav-link">
